...
OneFlagClass = QtCore.QAbstractAnimation.State
MultiFlagClass = QtCore.QAbstractAnimation.State

oneFlagRefValue1 = QtCore.QAbstractAnimation.State.Stopped
oneFlagRefValue2 = QtCore.QAbstractAnimation.State.Running
